...
function PhoneModal({ closeModal, name, job_place, job_calendar, job_description, good_skills, strong_skills, average_skills, weak_skills, tools, search, experiences }) {
    ...
    return (
        ...
        <div className="modal_overlay">
            <div className="modal">
                ...
                <div className="modal_main cv_modal">
